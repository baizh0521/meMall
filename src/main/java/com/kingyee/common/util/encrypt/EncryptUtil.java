...
public class EncryptUtil {
    ...
    public static void main(String[] args) throws Exception {
        //		System.out.println(EncryptUtil.getSHA1Value("N0vo积分1511235946NoRdi5k"));
        //        System.out.println(EncryptUtil.getSHA256Value("047591"));
        System.out.println(EncryptUtil.getSHA1Value("047591"));
        String str = "projectId=2userId=1email=dept=心血管内科userName=杨key=azzy9TmiVH92VAFy";
        System.out.println(EncryptUtil.getSHA256Value(str));
